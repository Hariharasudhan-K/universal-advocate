...
Agents Intensive - Capstone Project Submission Track: Agents for Good / Concierge Agents
...
Configure Environment: Rename .env.example to .env and add your API key:
...
Intake: Asks for lease dates and move-out photos.
Research: Identifies State Law requiring itemized deductions within 21 days.
Outcome: User gets a generated Demand Letter citing the specific code.
